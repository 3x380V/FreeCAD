...
TEST(MappedName, constructFromIndexedNameNoIndex)
{
    ...
    // Assert
    EXPECT_EQ(static_cast<const void*>(mappedName.dataBytes().data()),
              static_cast<const void*>(indexedName.getType()));  // shared memory
...
TEST(MappedName, constructFromIndexedNameWithIndex)
{
    ...
    // Assert
    EXPECT_NE(static_cast<const void*>(mappedName.dataBytes().data()),
              static_cast<const void*>(indexedName.getType()));  // NOT shared memory
    EXPECT_EQ(mappedName.isRaw(), false);
