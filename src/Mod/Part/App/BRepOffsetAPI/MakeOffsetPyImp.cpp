...
PyObject* MakeOffsetPy::addWire(PyObject* args, PyObject* /* kwd */)
{
    PyObject* wire {};
...
PyObject* MakeOffsetPy::perform(PyObject *args, PyObject* kwd)
{
    double offset {};
    double alt {};
    static const std::array<const char *, 3> keywords{"Offset", "Alt", nullptr};
    if (!Base::Wrapped_ParseTupleAndKeywords(args, kwd, "d|d", keywords, &offset, &alt)) {
        return nullptr;
    }
