...
PyObject* ApplicationPy::sExport(PyObject* /*self*/, PyObject* args)
{
    ...
    PY_TRY
    {
        ...
        if (ext == QLatin1String("iv") || ext == QLatin1String("wrl")
            ...
            || ext == QLatin1String("x3d") || ext == QLatin1String("x3dz")
            ...
            if (gui_doc) {
                ...
                if (view) {
                    ...
                    // setPdfVersion sets the printied PDF Version to comply with PDF/A-1b, more
                    // details under: https://www.kdab.com/creating-pdfa-documents-qt/
...
PyObject* ApplicationPy::sActivateWorkbenchHandler(PyObject* /*self*/, PyObject* args)
{
    ...
    PyObject* pcWorkbench =
        PyDict_GetItemString(Application::Instance->_pcWorkbenchDictionary, psKey);
    if (!pcWorkbench) {
...
PyObject* ApplicationPy::sAddWorkbenchHandler(PyObject* /*self*/, PyObject* args)
{
    ...
    try {
        ...
        PyDict_SetItemString(Application::Instance->_pcWorkbenchDictionary,
                             item.c_str(),
                             object.ptr());
...
PyObject* ApplicationPy::sGetMarkerIndex(PyObject* /*self*/, PyObject* args)
{
    ...
    PY_TRY
    {
        ...
        auto findIt =
            std::find_if(markerList.begin(), markerList.end(), [&marker_arg](const auto& it) {
        ...
        return Py_BuildValue("i",
                             Gui::Inventor::MarkerBitmaps::getMarkerIndex(marker_arg, defSize));
    }
    PY_CATCH;
}
...
PyObject* ApplicationPy::sGetUserEditMode(PyObject* /*self*/, PyObject* args)
{
    ...
    return Py::new_reference_to(
        Py::String(Application::Instance->getUserEditModeUIStrings().first));
}
