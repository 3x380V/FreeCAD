...
[x] 60280a0734 Import: Use ImportGui module for IGES import & export (#27363)
...
[x] 60cc44d33a Import: Fix import/export of STEP file (#27363)
...
[x] 00200a80f6 Gui: Simplify and fix code for ifcopenshell version check (#27243)
...
[x] bf7b370e05 App: In ExpressionParser::parse add the failing expression text to the error message (#27243)
[x] 7507da8433 App: Refactor PropertyExpressionEngine::afterRestore() (#27243)
[-] c1aa39f6be Start: Clean-up code
[x] 42742c9a71 Start: Fix possible crash when opening Start page (#21706)
[x] cd798605f8 Start: Fix flashing widget of Start page (#27904)
[x] 48c3610199 App: Fix several lint warnings (#27367)
...
[x] 8804030073 Sketcher: Handle exception in DrawSketchHandlerOffset::drawOffsetPreview (#27930)
...
[x] b36e679eb5 App: In ProjectFile::loadDocument() check for parse errors (#27243)
[x] f641e5ed19 Gui: Improve document recovery (#21659)
[x] 1683238e36 App: Improve handling with freeze status (#27355)
[x] 6bb8938e75 App: Remove assert() from PropertyXLink::Restore (#27243)
[x] d1cccfdfd0 App: Refactor Document::writeObjects (#27355)
[x] e11d4cd134 Base: Add C++ iostate methods to Writer class (#27355)
[x] 88f4e1f64b App: Improve Document::writeObjects (#27355)
...
[x] 3e719d8ada App: Add convenience methods to DocumentT and DocumentObjectT (#27367)
[x] 94b718f809 App: Fix some linter warnings (#27367)
...
[ ] aa59238882 Base: Update license header in FileTemplate
               ^- dropped
[x] a785ac50ff Core: Refactor code to install new and SIGSEGV handlers (#27854)
[x] 8ec6cc89f1 Part: Use signal handlers based on OCC's implementation (#27854)
[x] 20b3dceca5 [skip ci] Part: Use Part::SignalException in FCBRepAlgoAPI_BooleanOperation::Build (#27854)
...
[-] 50c7ea5f66 MSVC: Fix warnings & build failure (#23472)
...
[x] aeedd236d5 Fix macro Q_DISABLE_COPY_MOVE (#27367)
...
[x] f652184407 Gui: Refactor code to get program information (#27890)
...
[-] 95f42bdf61 Gui: Set minimum width to tree widget of actions panel (#20855)
...
[x] f8a5974f81 App: Add overloaded method Document::removeObject (#27367)
[x] c40f6f8336 App: Add overloaded method Application::closeDocument (#27367)
[x] 416566bae7 App: Move Python functions from Application to ApplicationPy (#27355)
[x] 3eecd1afa6 App: Fix linter warnings (#27367)
...
[x] c3f66a3229 App: Replace C macros with lambda expression (#27243)
...
[x] 6b0f969a3c Part: Implement ShapeAttributeProvider (#27841)
[x] 910914a1a9 Part: Implement PartPseudoShapeProvider (#27841)
[ ] a9e0fca883 Base: Create a quantity of value 0.0 instead of DOUBLE_MIN from an empty string
               ^- dropped, need to try harder resolving conflicts (after units merge)
[x] 8de005716a App: Optimize PropertyMaterialList::getDiffuseColors()/getTransparencies() (#27243)
...
[x] 17ad6a13bc App: Fix crash in Transaction::addObjectChange (#27243)
...
[x] 66cc0f23a3 Fem: Optimize netgen mesh creation (#27835)
...
[x] ad318ecbbf FEM: Fix build failures/warnings (#27835)
[ ] 0341aefa41 Draft: Fix _get_incmd_shortcut
[x] 2afc1d6573 Gui: Show date & time in locale specific format (#21659)
[x] 6372b63191 Start: Add date of creation and modification in tool tips (#27904)
...
[x] f545f37ca1 Use Application::getExecutableName() instead of Config()["ExName"] (#27355)
...
[x] b082d533cc Part: Fix crash in Revolution::execute() (#27929)
...
[x] 35982be775 Gui: Do not allow to activate disabled workbench (#27928)
...
[x] 44a7bf15f9 Improve handling of recent files list (#27904)
